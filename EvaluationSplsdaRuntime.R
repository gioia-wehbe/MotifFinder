#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
# RuntimeEvaluation: 
# Evaluates Runtime of SPLSDA
# Author: Gioia Wehbe
# LAST UPDATED: 22-02-15
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$


print("Inside SplsdaRuntimeEvaluation.R")
ptm <- proc.time()
...
runtime_summary_file=paste(runtime_files_dir,"/splsda_Runtime_Summary.csv",sep="")
...
runtime_files=list.files(runtime_files_dir,full.names=TRUE,pattern="Splsda*")
...
print("SPLSDA RuntimeEvaluation CODE ENDED!")   #print out in terminal an indication that the code has ended 
